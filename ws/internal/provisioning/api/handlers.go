...
const (
	...
	errCodeTopicQuotaExceeded    = "TOO_MANY_TOPICS"
	errCodeReservedTopicSuffix   = "RESERVED_TOPIC_SUFFIX"
	errCodeInvalidTopicSuffix    = "INVALID_TOPIC_SUFFIX"
	errCodeTopicAlreadyExists    = "TOPIC_ALREADY_EXISTS"
	errCodeTopicNotFound         = "TOPIC_NOT_FOUND"
	errCodeTopicReferencedByRule = "TOPIC_REFERENCED_BY_RULE"
	errCodeCreateTopicFailed     = "CREATE_TOPIC_FAILED"
	errCodeListTopicsFailed      = "LIST_TOPICS_FAILED"
	errCodeDeleteTopicFailed     = "DELETE_TOPIC_FAILED"
